...
public class MusicVolume : MonoBehaviour 
{
	...
	void Update () 
	{
		...
		if(Director._Instance._MusicVolume > 0.9f)
		{
			_Sprite.SetFrame(0);
		}
		else if(Director._Instance._MusicVolume > 0.8f)
		{
			_Sprite.SetFrame(1);
		}
		else if(Director._Instance._MusicVolume > 0.7f)
		{
			_Sprite.SetFrame(2);
		}
		else if(Director._Instance._MusicVolume > 0.6f)
		{
			_Sprite.SetFrame(3);
		}
		else if(Director._Instance._MusicVolume > 0.5f)
		{
			_Sprite.SetFrame(4);
		}
		else if(Director._Instance._MusicVolume > 0.4f)
		{
			_Sprite.SetFrame(5);
		}
		else if(Director._Instance._MusicVolume > 0.3f)
		{
			_Sprite.SetFrame(6);
		}
		else if(Director._Instance._MusicVolume > 0.2f)
		{
			_Sprite.SetFrame(7);
		}
		else if(Director._Instance._MusicVolume > 0.1f)
		{
			_Sprite.SetFrame(8);
		}
		else if(Director._Instance._MusicVolume > 0.0f)
		{
			_Sprite.SetFrame(9);
		}
		else
